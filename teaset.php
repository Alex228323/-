...
<HEAD>
  ...
  <META name="Чайный сервиз" content="Крылов Алексей">
  <META name="viewport" content="width=device-width, initial-scale=1.0">
  <META name="description" content="Наслаждайтесь ароматом чая и чувством уюта, превратив своё чаепитие в незабываемое событие
  с помощью эксклюзивного чайного сервиза от Чайного дома" />
  <META name="keywords" content="чайный сервиз, онлайн, по акции, купить, заказать, в подарок, в Москве, на заказ" />
  ...
  <TITLE>Уникальный чайный сервиз: единственная в своём роде посуда в Москве
  </TITLE>
</HEAD>
...
<!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date(); for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(92701746, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/92701746" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
  ...
  <div class="tabw">
    <div class="blok">
      <?php
      $query = "SELECT * FROM `products` where category='Чайный сервиз'";
      $result = mysqli_query($connect, $query);
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_array($result)) {
      ?>
          <div class="blok1">
            <FORM method="post" action="teaset.php?action=add&id=<?php echo $row["Id_products"]; ?>">
              <FIGURE>
                <div>
                  <A href="tovar.php?id=<?php echo $row["Id_products"]; ?>"><IMG src="<?php echo $row["img"]; ?>" class="tovar" alt="Чайный сервиз"></A>
